	...
	protected void buildGraph() {
		if (getGraph() == null) {
			graph = newGraph();
			 ...
			 System.out.println("[PF] buildGraph: factory width=" + getFactoryModel().getWidth()
		                + ", height=" + getFactoryModel().getHeight()
		                + ", resolution=" + getResolution());
			final int xSize = getFactoryModel().getWidth() / getResolution();
			final int ySize = getFactoryModel().getHeight() / getResolution();
			
			System.out.println("[PF] grid size: xSize=" + xSize + ", ySize=" + ySize);
