...
public class Room extends Component {
	...
	public boolean overlays(final PositionedShape shape) {
		return (leftWall != null && leftWall.overlays(shape))
	            || (rightWall != null && rightWall.overlays(shape))
	            || (topWall != null && topWall.overlays(shape))
	            || (bottomWall != null && bottomWall.overlays(shape));
	}
	...
	public boolean canBeOverlayed(final PositionedShape shape) {
		...
		if ((leftWall != null && leftWall.overlays(shape))
	            || (rightWall != null && rightWall.overlays(shape))
	            || (topWall != null && topWall.overlays(shape))
	            || (bottomWall != null && bottomWall.overlays(shape))) {
			return false;
